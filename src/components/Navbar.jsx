    ...
    <header className='sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-0'>
      ...
      <div className='md:mr-4 flex justify-between w-full'>
                    <a href="#" className='mr-6 flex items-center space-x-2'>
                        {/* Adjust the width here to be smaller */}
      ...
      {mobileMenuOpen && (
        <div className='md:hidden'>
            <div className='space-y-1 px-2 pb-3 pt-2'>
                ...
                <a href="#testimonials" className='block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900'>Experience</a>
