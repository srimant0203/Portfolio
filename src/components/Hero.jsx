  ...
  return (
    <section className='relative'>
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between'>
          <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
            <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Hi There, <br />I'm Srimanta <span className='text-red-500'>Kumar Acharjya</span></h1>
            <p className='md:text-2xl text-xl mb-4'>Web Developer</p>
            <p className='mb-4'>I'm a passionate web developer with expertise in React modern web technologies. I love creating beautiful and functional websites that solve real-world problems.</p>
      ...
      <div className='absolute top-40 right-10 hidden bg-gray-200 p-4 md:flex flex-col gap-6 rounded-full'>
        <a href="https://github.com/srimant0203" target="_blank" rel="noopener noreferrer">
          <img src={Github} alt="Github" className='w-20'/>
        </a>
        <a href="https://www.linkedin.com/in/srimanta-kumar-acharjya-2791a6227/" target="_blank" rel="noopener noreferrer">
